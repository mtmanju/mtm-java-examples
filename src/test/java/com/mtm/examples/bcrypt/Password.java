package com.mtm.examples.bcrypt;
...
public class Password {
     ...
     *
     * @param password_plaintext The account's plaintext password as provided during account
     ...
     *
     * @param password_plaintext The account's plaintext password, as provided during a login
     *                           request
     ...
     */
    @Test
    public void testPreGeneratedPasswordHash() {
        String test_passwd = "123456";
        String test_hash = "$2a$10$04TVADrR6/SPLBjsK0N30.Jf5fNjBugSACeGv1S69dZALR7lSov0y";
