package com.mtm.examples.databene.benerator;
...
public class GenerateData {
    ...
    public static void main(String[] args) {
        ...
        // Retrieve resource
        String retrievedResource = GenerateData.class.getResource("sample.json").getFile();
        log.info("Retrieved Resource: {}", retrievedResource);
    }
